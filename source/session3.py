...
if __name__ == "__main__":
    ...
    neural_network = multi_layer_perceptron(img_size = 32,batch_size = 16, dataset_dir = DATA_PATH, model_fname = 'my_first_mlp.h5')
	...
	if SVM == False:
		...
		features, labels = neural_network.get_layer_output(layer ='last',image_set = 'train')
		if cross_validate == False:
			neural_network.train_classifier_SVM(features, labels)
			features, labels = neural_network.get_layer_output(layer ='last',image_set = 'test')	
