...
train_images_filenames = cPickle.load(open(path.join(DATA_PATH, 'train_images_filenames.dat'), 'r'))
test_images_filenames = cPickle.load(open(path.join(DATA_PATH, 'test_images_filenames.dat'), 'r'))
train_labels = cPickle.load(open(path.join(DATA_PATH, 'train_labels.dat'), 'r'))
